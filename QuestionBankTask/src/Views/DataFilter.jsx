          ...
          <div className='w-[100%] h-[100%] col-span-1'>
              <div className='w-[100%] h-[100%] flex flex-col justify-between'>
                  ...
                  <div className='flex gap-2 self-center'>
                    ...
                    <div className='text-[#008000] text-[15px] font-[500] underline cursor-pointer'>Reset bộ lọc</div></div>
              </div>
          </div>
                  ...
                  <div className='w-[100%]'>
                    <div className='relative flex self-center'>
                        ...
                        <div className='w-[100%] h-[34px] grid grid-cols-9 gap-2'>
                          <div className='w-[100%] h-[100%] col-span-6 shadow-bottom-right'><input type="text" placeholder='Tìm theo mã và câu hỏi' className='w-[100%] h-[100%] rounded-e-[4px]'/></div>                         
                          <div className=' col-span-1 w-[100%] bg-[#008000]  rounded-[3px] shadow cursor-pointer'>
                            <div className='flex justify-center gap-1 w-[100%] h-[100%]'>
