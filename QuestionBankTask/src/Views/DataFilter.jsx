          ...
          <div className='h-[100%] col-span-1'>
              <div className='h-[100%] flex flex-col justify-between'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    <div className='text-[#008000] text-[15px] font-[500] underline cursor-pointer hover:text-[#008000a2]'onClick={() => {resetFilter()}} title={"Reset bộ lọc"} >Reset bộ lọc</div></div>
              </div>
          </div>
          <div className=' h-[100%] col-span-4'>
              <div className=' h-[100%] flex flex-col justify-between'>
                  <div className='text-[#959DB3] font-[600] search-text-shadow pb-1' >Tìm kiếm</div>
                  <div className=''>
                    <div className='relative flex '>
                        ...
                        <div className=' h-[34px] flex gap-2'>
                          ...
                          <div className='w-[60px]  bg-[#008000]  rounded-[3px] shadow cursor-pointer'>
                            <div className='flex justify-center gap-1 shadow-lg shadow-[#ADDEF6] h-[100%] hover:shadow-[#45b5ff] rounded-[3px]' onClick={() => {handleSearch()}} title={"Tìm"} >
